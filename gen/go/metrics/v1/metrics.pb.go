...
type Metric struct {
	...
	// time_unix_nano is the end of the time interval over which all data for
	// this Metric were recorded. It MUST be represented as the UNIX Epoch
	...
	// is define by the receiver as the time this data is received. It is NOT
	// RECOMMENDED to leave this unspecified.
	...
	Int64DataPoints      []*Int64DataPoint     `protobuf:"bytes,4,rep,name=int64_data_points,json=int64DataPoints,proto3" json:"int64_data_points,omitempty"`
	DoubleDataPoints     []*DoubleDataPoint    `protobuf:"bytes,5,rep,name=double_data_points,json=doubleDataPoints,proto3" json:"double_data_points,omitempty"`
	HistogramDataPoints  []*HistogramDataPoint `protobuf:"bytes,6,rep,name=histogram_data_points,json=histogramDataPoints,proto3" json:"histogram_data_points,omitempty"`
	SummaryDataPoints    []*SummaryDataPoint   `protobuf:"bytes,7,rep,name=summary_data_points,json=summaryDataPoints,proto3" json:"summary_data_points,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *Metric) GetTimeUnixNano() uint64 {
	if m != nil {
...
func (m *Int64DataPoint) GetEndTimeUnixNano() uint64 {
	if m != nil {
...
func (m *DoubleDataPoint) GetEndTimeUnixNano() uint64 {
	if m != nil {
		return m.EndTimeUnixNano
	}
	return 0
...
func (m *HistogramDataPoint) GetEndTimeUnixNano() uint64 {
	if m != nil {
		return m.EndTimeUnixNano
	}
	return 0
...
func (m *SummaryDataPoint) GetEndTimeUnixNano() uint64 {
	if m != nil {
		return m.EndTimeUnixNano
	}
	return 0
...
var fileDescriptor_3c3112f9fa006917 = []byte{
	...
	,
}
